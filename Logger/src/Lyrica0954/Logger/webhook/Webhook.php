        ...
        if ($async){
            ...
            if (!$event->isCancelled()){
                ...
                try{
                    ...
                    return new WebhookResponse(WebhookResponse::RESPONSE_ERROR, "{$e}", "Error occured. ");
                }
                if ($response === ''){
                    return new WebhookResponse(WebhookResponse::RESPONSE_SUCCESS, "", "Request succeeded. ");
                } else {
                    return new WebhookResponse(WebhookResponse::RESPONSE_FAILED, "{$response}", "Request failed. ");
                }
            } 
            return new WebhookResponse(WebhookResponse::RESPONSE_CANCELLED, "", "WebhookSendEvent Cancelled. ");
        }
    }
